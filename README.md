...
The key question for VLX-Seek is:

> How can a VLM gain fine-grained localization ability without forcing the language model to generate fragile coordinate strings?

VLX-Seek answers this by turning visual regions into language-addressable entities.
