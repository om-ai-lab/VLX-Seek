...
> 如何让 VLM 获得细粒度定位能力，同时避免让语言模型生成脆弱的坐标字符串？

VLX-Seek 的答案是：把视觉区域变成语言模型可以寻址和引用的实体。
...
VLX-Seek 的 3B 版本模型在多个细粒度感知任务上展现出较强表现，超过了许多参数规模更大的开源和闭源大模型。
...
<p align="left">
  <img src="assets/qrcode.png" alt="微信社群二维码" width="200">
</p>
